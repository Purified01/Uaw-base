...
function Definitions()
	...
	STANDARD_LOW_CASH_START = {
		...
		BuildOrder = {
			{ Type="Military_Bunker",					Count=1, ExitThread=false },
			{ Type="Military_Build_Bot",						Count=1, ExitThread=false },
			{ Type="Military_Supply",						Count=3, ExitThread=false },
		}
	}
	...
	STANDARD_INVASION_MOVE_01 = {
		...
		{
			{ Type="Military_Bunker",					Count=1, ExitThread=false },
			{ Type="Military_Supply",					Count=2, ExitThread=false },
		}
	}

	STANDARD_OPENING_MOVES_TEST = { --Used for testing only
		Options = { DurationMin=10.0, DurationMax=50.0, KillThreadsWhenDone=true },
		BuildOrder = {
			{ Type="Military_Superweapon_Missile",		Count=1, ExitThread=false },
		}
	}
	...
	STANDARD_OPENING_MOVES = {
		...
		BuildOrder = {
			{ Type="Military_Bunker",					Count=1, ExitThread=false },
			{ Type="Military_Build_Bot",				Count=2, ExitThread=false },
			{ Type="Military_Supply",					Count=3, ExitThread=false },
			{ Type="Military_Team_Marines",				Count=1, ExitThread=false },
			{ Type="Military_Medic",					Count=5, ExitThread=false },	-- 6 12
		}
	}
	...
	STANDARD_OPENING_MOVES_01 = {
		...
		BuildOrder = {
			...
			{ Type="Military_Build_Bot",				Count=2, ExitThread=false },
			{ Type="Military_Supply",					Count=3, ExitThread=false },
			{ Type="Military_Team_Marines",				Count=3, ExitThread=false },
			{ Type="Military_Medic",					Count=5, ExitThread=false },
			{ Type="Military_Team_Flamethrower",		Count=1, ExitThread=false },
			{ Type="Military_Hummer",					Count=1, ExitThread=false },
		}
	}
	...
	STANDARD_FASTSTART_MOVE = {
		...
		BuildOrder = {
			...
			{ Type="Military_Supply",					Count=3, ExitThread=false },
			{ Type="Military_Team_Marines",				Count=3, ExitThread=false },
			{ Type="Military_Medic",					Count=4, ExitThread=false },
			{ Type="Military_Hummer",					Count=1, ExitThread=false },
		}
	}
	...
	STANDARD_OPENING_MOVES_02 = {
		...
		BuildOrder = {
			...
			{ Type="Military_Medic",					Count=5, ExitThread=false },
			{ Type="Military_Team_Flamethrower",		Count=1, ExitThread=false },
			{ Type="Military_Hummer",					Count=4, ExitThread=false },
			{ Type="Military_Hero_Randal_Moore",		Count=1, ExitThread=false },
		}
	}
	...
	STANDARD_MIDGAME_MOVES = {
		...
		BuildOrder = {
			{ Type="Military_Build_Bot",				Count=3, ExitThread=false },
			{ Type="Military_Supply",					Count=5, ExitThread=false },
			{ Type="Military_Team_Marines",				Count=2, ExitThread=false },
			{ Type="Military_Medic",					Count=4, ExitThread=false },
			{ Type="Military_Team_Flamethrower",		Count=1, ExitThread=false },
			{ Type="Military_Hummer",					Count=4, ExitThread=false },
			{ Type="Military_Hero_Randal_Moore",		Count=1, ExitThread=false },
			{ Type="Military_Dragonfly_UAV",			Count=2, ExitThread=false },
			{ Type="Military_Apache",					Count=3, ExitThread=false },
			{ Type="Military_Defender_APC",				Count=4, ExitThread=false },
			{ Type="Military_AbramsM2_Tank",			Count=1, ExitThread=false },			
		}
	}
	...
	STANDARD_ENDGAME_MOVES = {
		...
		BuildOrder = {
			{ Type="Military_Build_Bot",				Count=4, ExitThread=false },			
			{ Type="Military_Supply",					Count=6, ExitThread=false },
			{ Type="Military_Nuclear_Reactor",			Count=1, ExitThread=false },
			{ Type="Military_Medic",					Count=5, ExitThread=false },
			{ Type="Military_Team_Flamethrower",		Count=1, ExitThread=false },
			{ Type="Military_Team_Rocketlauncher",		Count=3, ExitThread=false },
			{ Type="Military_Hummer",					Count=2, ExitThread=false },
			{ Type="Military_Maverick_Jet",		    	Count=3, ExitThread=false },
			{ Type="Military_Hero_Tank",				Count=1, ExitThread=false },
			{ Type="Military_Hero_Randal_Moore",		Count=1, ExitThread=false },
			{ Type="Military_Apache",					Count=4, ExitThread=false },
			{ Type="Military_Defender_APC",				Count=3, ExitThread=false },
			{ Type="Military_AbramsM2_Tank",			Count=4, ExitThread=false },
			{ Type="Military_Superweapon_Missile",		Count=1, ExitThread=false },
			{ Type="Military_Dragoon_MTRV",		    	Count=1, ExitThread=false },		
		}
	}
end
...
function Compute_Desire()
	...
	if not Is_Player_Of_Faction(Player, "MILITARY") then
		--Goal.Suppress_Goal()
		return -2.0
	end
...
function On_Activate()
	...
	Create_Thread("military_Research")
end
...
-- ----------------------------------------------------------------
-- military_Research: Manage all novus research
-- ----------------------------------------------------------------
function military_Research()
	...
	while true do
		...
		if not def_con and Player.Get_Credits() > 4000.0 and ( research_block ==nil or research_block.IsFinished() ) then
