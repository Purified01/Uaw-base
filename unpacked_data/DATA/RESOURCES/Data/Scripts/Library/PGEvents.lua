-- $Id: //depot/Projects/Invasion/Run/Data/Scripts/Library/PGEvents.lua#4 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/Invasion/Run/Data/Scripts/Library/PGEvents.lua $
--
...
function Default_Unit_Damaged(tf, unit, attacker, deliberate)
	...
	if not TestValid(unit) or not TestValid(attacker) or attacker.Is_Category("Stationary") then
		return
	end
	...
	if unit.Is_Category("Small") then
	...
	elseif 	 (unit.Get_Hull() < 0.5) and ((unit.Get_AI_Power_Vs_Unit(attacker) > 0) or (unit.Get_Time_Till_Dead() < 25)) then
		...
		elseif unit.Is_Category("Piloted") then
...
function Should_Crush(unit, target)
	...
	if	unit.Has_Property("GoodInfantryCrusher") and target.Is_Category("Small") and target.Is_Ability_Active("SPREAD_OUT") then
		return true
	end
...
function Default_Target_In_Range(tf, unit, target)
	...
	unit.Activate_Ability("ROCKET_ATTACK", target.Is_Category("Stationary"))
