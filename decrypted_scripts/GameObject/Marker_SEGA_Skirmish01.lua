...
-- $Id: //depot/Projects/Invasion_360/Run/Data/Scripts/GameObject/Marker_SEGA_Skirmish01.lua#9 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/Invasion_360/Run/Data/Scripts/GameObject/Marker_SEGA_Skirmish01.lua $
--
...
function Thread_Mission_Start()
	...
	list_masari_victory_relevant_units = Find_All_Objects_With_Hint("victory")
	
	--All_Locks_Off(masari, true)
	
	Create_Thread("Thread_Monitor_Victory")
...
function Thread_Monitor_Victory()
	_CustomScriptMessage("JoeLog.txt", string.format("Thread_Monitor_Victory hit!!"))
	local bool_masari_exist
	local counter_loop = 0
	while true do
		Sleep(5)
		
		
		
		bool_masari_exist = false
		for i, masari_unit in pairs(list_masari_victory_relevant_units) do
			if TestValid(masari_unit) then
				bool_masari_exist = true
				_CustomScriptMessage("JoeLog.txt", string.format("bool_masari_exist = true"))
				counter_loop = counter_loop + 1
				_CustomScriptMessage("JoeLog.txt", string.format("counter_loop = %d", counter_loop))
				break
			end
		end
		
		if bool_masari_exist == false then
			_CustomScriptMessage("JoeLog.txt", string.format("bool_masari_exist == false"))
