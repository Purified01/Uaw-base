-- $Id: //depot/Projects/Invasion/Run/Data/Scripts/GUI/Video_Options_Dialog.lua#36 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/Invasion/Run/Data/Scripts/GUI/Video_Options_Dialog.lua $
--
	...
	for _, res in pairs(Resolutions) do
		if res.Resolution.Width == Settings.Screen_Width and
			...
			if highlight then
				...
				this.List_Box_Resolutions.Set_Row_Background(res.Row_ID, COLOR_DARK_GREY)
			end
...
function Apply_Settings(settings)
	if HighlightedEntry then
		this.List_Box_Resolutions.Set_Row_Background(HighlightedEntry.Row_ID, COLOR_BLACK)
	end
