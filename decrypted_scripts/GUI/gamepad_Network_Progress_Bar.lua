...
-- $Id: //depot/Projects/Invasion_360/Run/Data/Scripts/GUI/gamepad_Network_Progress_Bar.lua#4 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/Invasion_360/Run/Data/Scripts/GUI/gamepad_Network_Progress_Bar.lua $
--
...
function Gamepad_Compatability_Init()
	this.Register_Event_Handler("Controller_B_Button_Up", this.Button_Cancel, On_Cancel_Clicked)
...
function Start(asset_bank_names)
	...
	if (Is_Xbox() or Is_Gamepad_Active()) then
		this.Quad_B_Button.Set_Hidden(false)
	end
...
function Hide_Cancel_Button()
	...
	this.Quad_B_Button.Set_Hidden(true)
end
