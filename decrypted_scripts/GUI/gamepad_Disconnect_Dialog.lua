...
-- $Id: //depot/Projects/Invasion_360/Run/Data/Scripts/GUI/gamepad_Disconnect_Dialog.lua#5 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/Invasion_360/Run/Data/Scripts/GUI/gamepad_Disconnect_Dialog.lua $
--
...
function On_Init()
	...
	for index, kick_button in pairs(Kick_Buttons) do
		kick_button.Set_Tab_Order(index-1)
		this.Register_Event_Handler("Button_Clicked", kick_button, Vote_Kick_Player)
	end

	this.Register_Event_Handler("Controller_B_Button_Up", nil, Quit_Game)
	this.Register_Event_Handler("Controller_Back_Button_Up", nil, Quit_Game)
