...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/Invasion_360/Run/Data/Scripts/GUI/Gamepad_Global_Mode_Colors.lua $
--
...
function Init_Global_Mode_Colors()
	...
	-- With the Gamepad a region can be selected, so we want to make sure its coloring conveys this idea!.
	REGION_COLOR_SELECTED["ALIEN"] = { 1.0, 1.0, 0.7 }
	...
	-- With the Gamepad a region can be selected, so we want to make sure its coloring conveys this idea!.
	REGION_COLOR_SELECTED["NOVUS"] = { 1.0, 1.0, 0.7 }
