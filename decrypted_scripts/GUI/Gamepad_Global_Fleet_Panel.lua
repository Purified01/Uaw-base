...
-- $Id: //depot/Projects/Invasion_360/Run/Data/Scripts/GUI/Gamepad_Global_Fleet_Panel.lua#9 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/Invasion_360/Run/Data/Scripts/GUI/Gamepad_Global_Fleet_Panel.lua $
--
...
function On_Init()
	...
	for index, button in pairs(type_buttons) do
		...
		this.Register_Event_Handler("Selectable_Icon_Gained_Focus", button, On_Gain_Focus)
		this.Register_Event_Handler("Selectable_Icon_Lost_Focus", button, On_Lose_Focus)			
	end
	...
	Set_GUI_Variable("UpdateFocus", false)
end
...
function On_Update()
	...
	if Get_GUI_Variable("UpdateFocus") then
		this.Focus_First()
		Set_GUI_Variable("UpdateFocus", false)
	end
end
...
function Open()
	this.Set_State("Open")
	Set_GUI_Variable("UpdateFocus", true)
end
...
--
-- -----------------------------------------------------------------------------------------------------------------------------------------
function On_Gain_Focus(_, button)
	Set_GUI_Variable("MouseOverButton", button)
end
...
--
-- -----------------------------------------------------------------------------------------------------------------------------------------
function On_Lose_Focus(_, button)
	Set_GUI_Variable("MouseOverButton", nil)
end
